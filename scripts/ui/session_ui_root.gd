...
func _reward_choice_panel_style() -> StyleBox:
	# Shared textured popup frame; the RewardChoiceMargin handles inner padding.
	return DungeonUiTheme.framed_panel_style(10.0, 8.0)
