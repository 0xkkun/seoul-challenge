...
const ENTRIES: Array[Dictionary] = [
	...
	{"id": &"p3_first_window", "speaker": SPEAKER_PEOPLE3, "tier": TIER_FIRST_VISIT,
	 ...
	 "text": "야자 전에 창밖 봤어? 운동장이 유난히 멀어 보여."},
	...
	{"id": &"p3_first_captain", "speaker": SPEAKER_PEOPLE3, "tier": TIER_FIRST_VISIT,
	 "system_link": &"purify_friend", "weight": 1, "condition": &"", "memory": "",
	 "text": "야구부 주장, 요즘 통 안 보여. 어디 아픈가?"},
	{"id": &"p3_first_alone", "speaker": SPEAKER_PEOPLE3, "tier": TIER_FIRST_VISIT,
	 "system_link": &"locker", "weight": 1, "condition": &"", "memory": "",
	 "text": "복도 끝은 혼자 가지 마. …그냥, 느낌이 싫어."},
	{"id": &"p3_first_clock", "speaker": SPEAKER_PEOPLE3, "tier": TIER_FIRST_VISIT,
	 "system_link": &"night_palace", "weight": 1, "condition": &"", "memory": "",
	 "text": "야자만 시작하면 시계가 이상하게 느려져."},
	{"id": &"p3_purify_captain", "speaker": SPEAKER_PEOPLE3, "tier": TIER_POST_PURIFY,
	 "system_link": &"purify_friend", "weight": 1, "condition": &"", "memory": "",
	 "text": "주장 다시 운동장 나왔더라. 어찌나 반갑던지."},
	{"id": &"p3_purify_window2", "speaker": SPEAKER_PEOPLE3, "tier": TIER_POST_PURIFY,
	 "system_link": &"night_palace", "weight": 1, "condition": &"", "memory": "",
	 "text": "운동장이 다시 가까워 보여. 착각이었나 봐."},
	# E3 foreshadow (낮은 빈도, 밤 궁 복선)
	{"id": &"p3_fs_gate", "speaker": SPEAKER_PEOPLE3, "tier": TIER_POST_PURIFY,
	 "system_link": &"night_palace", "weight": 1, "condition": &"", "memory": "",
	 "text": "정문이 밤마다 다른 데로 이어진대… 농담이지?"},
	{"id": &"p3_enh_glow", "speaker": SPEAKER_PEOPLE3, "tier": TIER_POST_ENHANCED,
	 "system_link": &"memory_weapon", "weight": 1, "condition": &"", "memory": "",
	 "text": "그 방망이, 밤마다 희미하게 빛난다는 소문 알아?"},
	{"id": &"p3_enh_changed", "speaker": SPEAKER_PEOPLE3, "tier": TIER_POST_ENHANCED,
	 "system_link": &"purify_friend", "weight": 1, "condition": &"", "memory": "",
	 "text": "너 요즘 좀 달라 보여. …좋은 쪽으로."},
	...
	{"id": &"p4_first_seat", "speaker": SPEAKER_PEOPLE4, "tier": TIER_FIRST_VISIT,
	 "system_link": &"purify_friend", "weight": 2, "condition": &"", "memory": "",
	 "text": "주장 자리, 며칠째 비었던데."},
	{"id": &"p4_first_number", "speaker": SPEAKER_PEOPLE4, "tier": TIER_FIRST_VISIT,
	 "system_link": &"locker", "weight": 1, "condition": &"", "memory": "",
	 "text": "사물함 번호 외우지 마. 걔가 기억한대."},
	{"id": &"p4_first_empty", "speaker": SPEAKER_PEOPLE4, "tier": TIER_FIRST_VISIT,
	 "system_link": &"night_palace", "weight": 1, "condition": &"", "memory": "",
	 "text": "야자 끝나도 아무도 운동장 안 가더라."},
	...
	{"id": &"p4_purify_eyes", "speaker": SPEAKER_PEOPLE4, "tier": TIER_POST_PURIFY,
	 "system_link": &"purify_friend", "weight": 1, "condition": &"", "memory": "",
	 "text": "걔 눈빛 좀 변하지 않았어?"},
	{"id": &"p4_purify_laugh", "speaker": SPEAKER_PEOPLE4, "tier": TIER_POST_PURIFY,
	 "system_link": &"purify_friend", "weight": 1, "condition": &"", "memory": "",
	 "text": "걔 웃는 거, 진짜 오랜만에 봤어."},
	{"id": &"p4_purify_field", "speaker": SPEAKER_PEOPLE4, "tier": TIER_POST_PURIFY,
	 "system_link": &"night_palace", "weight": 1, "condition": &"", "memory": "",
	 "text": "요즘은 운동장이 그냥 운동장처럼 보여."},
	{"id": &"p4_enh_weapon", "speaker": SPEAKER_PEOPLE4, "tier": TIER_POST_ENHANCED,
	 "system_link": &"memory_weapon", "weight": 1, "condition": &"", "memory": "",
	 "text": "누가 사물함에서 방망이 같은 걸 꺼냈대."},
	{"id": &"p4_enh_warm", "speaker": SPEAKER_PEOPLE4, "tier": TIER_POST_ENHANCED,
	 "system_link": &"memory_weapon", "weight": 1, "condition": &"", "memory": "",
	 "text": "그 방망이 손잡이가 따뜻하더래. 이상하지."},
	{"id": &"p4_enh_ready", "speaker": SPEAKER_PEOPLE4, "tier": TIER_POST_ENHANCED,
	 "system_link": &"memory_weapon", "weight": 1, "condition": &"", "memory": "",
	 "text": "이번 밤엔 좀 버틸 수 있으려나."},
	...
	{"id": &"p4_died_cried", "speaker": SPEAKER_PEOPLE4, "tier": TIER_FIRST_VISIT,
	 ...
	 "text": "어젯밤에 운동장에서 누가 울었대."},
	{"id": &"p4_died_early", "speaker": SPEAKER_PEOPLE4, "tier": TIER_FIRST_VISIT,
	 "system_link": &"night_palace", "weight": 1, "condition": &"last_run_died", "memory": "",
	 "text": "오늘은 다들 일찍 갔어. …어젯밤 일 때문에."},
	...
	{"id": &"p4_cleared_relief", "speaker": SPEAKER_PEOPLE4, "tier": TIER_POST_PURIFY,
	 "system_link": &"purify_friend", "weight": 1, "condition": &"last_run_cleared", "memory": "",
	 "text": "무사히 돌아왔다며? 휴, 다행이야."},
	# E3 foreshadow
